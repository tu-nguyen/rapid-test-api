...
def main():
    ...
    parser.add_argument("--port", type=str, default=port, help="Choose port to use")
    parser.add_argument("--model", type=str, help="Use JSON file to generate models")
    parser.add_argument("--endpoint", type=str, help="Use JSON file to generate endpoints")
